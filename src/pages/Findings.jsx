...
export default function Findings() {
  ...
  const [data, setData] = useState({ findings: [], audits: [], owners: [], controls: [], submissions: [], orgUnits: [] });
  ...
  const load = async () => {
    try {
      const [findings, audits, owners, controls, submissions, orgUnits] = await Promise.all([
        base44.entities.Finding.list("-created_date", 1000), base44.entities.Audit.list("-created_date", 500), base44.entities.Owner.list("full_name", 1000), base44.entities.AuditControl.list("control_number", 5000), base44.entities.EvidenceSubmission.list("-created_date", 5000), base44.entities.OrgUnit.list("name", 1000),
      ]);
      setData({ findings, audits, owners, controls, submissions, orgUnits });
